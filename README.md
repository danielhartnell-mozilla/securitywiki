...
- Retrieve LocalSettings.php from S3 bucket secret store
- Maybe modify LocalSettings.php to use ENV when applicable
- Setup RDS
- Validate that this repository does not contain malicious or unexpected code
- Provide credit to authors or write my own implementation of this
- Review license agreement to see if I'm adhering to the author's requests
- Setup the database
